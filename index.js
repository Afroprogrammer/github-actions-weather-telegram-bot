...
weatherURL.searchParams.set('lat', '5.6242019')
weatherURL.searchParams.set('lon', '-0.2276807')     
...
`The weather in ${weatherData.name}: ${weatherData.weather[0].description}. Current temperature is 
